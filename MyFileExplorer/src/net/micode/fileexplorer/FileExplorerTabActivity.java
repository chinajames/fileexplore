...
//    	if (mTabsAdapter.getItem(mViewPager.getCurrentItem()) instanceof FileCategoryActivity) {
//    		FileCategoryActivity  f = (FileCategoryActivity) mTabsAdapter.getItem(mViewPager.getCurrentItem());
//    		return f.dispatchKeyEvent(event);
//    	}
